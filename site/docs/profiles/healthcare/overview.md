...
This profile is designed to compose with the [Governance Profile](/profiles/governance/overview). Organizations **SHOULD** declare both profiles for full enterprise healthcare compliance coverage.
