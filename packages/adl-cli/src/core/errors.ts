...
/**
 * ADL error codes per spec §16.2
 */
export const ADL_ERRORS: Record<string, { category: string; description: string }> = {
  // Parse errors
...
export function formatErrorsTerminal(file: string, errors: ADLError[]): string {
  const lines: string[] = [];
